...
},{"./audioplayer.js":327,"./main.js":329,"babel-polyfill":1}],329:[function(require,module,exports){
"use strict";
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    getSongs().then(function (songs) {
        player = new _audioplayer2.default(songs);
        player.init();
        setSongAlbum(songs);
    });
...
var setSongAlbum = function setSongAlbum(songs) {
    songs.forEach(function (song, index) {
        var template = document.querySelector("#song-picker"),
